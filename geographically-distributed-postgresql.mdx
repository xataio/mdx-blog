...
If are looking to distribute your Postgres database, either geographically or horizontally in the same region, we'd love to chat with you! Please say hi on our [discord](https://xata.io/discord) or over [email](mailto:info@xata.io).
