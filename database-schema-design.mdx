...
<div style="width:100%;height:0;padding-bottom:50%;position:relative;"><iframe src="https://giphy.com/embed/AaBhK3dHsk0XS" width="100%" height="100%" style="position:absolute" frameBorder="0" class="giphy-embed" allowFullScreen></iframe></div><p><a href="https://giphy.com/gifs/look-reports-devs-AaBhK3dHsk0XS">via GIPHY</a></p>
...
Here are **10** pointers to consider (in no particular order) for good database schema design:
