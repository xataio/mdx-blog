...
Though we realize every company, business and database are unique and different. With [custom playbooks](https://github.com/xataio/agent/pull/61), you can create your own playbook or fork one of Xata’s. This is the first step toward building out a library of custom workflows specific to your needs. We have already started work on [adding custom tools via MCP](https://github.com/xataio/agent/issues/79) and envision the agent authoring and revising its own playbooks.
