...
description: Version 0.2.0 introduces a redesigned chat interface, customizable playbooks, support for monitoring PostgreSQL instances on Google Cloud Platform (GCP) and various improvements across the board.
image:
...
![New Gemini & GPT models now available for chat and scheduled playbooks](/images/agent/agent-model-gemini.png)
