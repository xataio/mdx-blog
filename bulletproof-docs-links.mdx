...
<ArticleImage src="https://xata.io/images/blog/bulletproof-docs-links/Untitled.png" width="1820" height="1213" alt="This is fine meme" caption="This is fine" position="center" />
...
<ArticleImage src="https://xata.io/images/blog/bulletproof-docs-links/Untitled%201.png" width="1246" height="588" alt="Console output" caption="Console output" position="center" />
...
<ArticleImage src="https://xata.io/images/blog/bulletproof-docs-links/Untitled%202.png" width="1038" height="464" alt="Errors output" caption="Error are now output" position="center" />
...
<ArticleImage src="https://xata.io/images/blog/bulletproof-docs-links/Untitled%203.png" width="901" height="719" alt="Test runner" caption="Test runner" position="center" />
...
- We’re instatiating a `links` set, ready to be filled
...
describe("markdown link checker", async () => {
  ...
  const pages = new Map<
    FilePath,
    { anchors: Set<string>; links: Set<string> }
  >();
...
<ArticleImage src="https://xata.io/images/blog/bulletproof-docs-links/Untitled%204.png" width="763" height="499" alt="Test output" caption="Test output" position="center" />
