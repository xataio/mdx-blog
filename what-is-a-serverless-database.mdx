---
title: "What we talk about when we talk about serverless databases"
description: "What is a Serverless Database? There isn't a definitive definition that everyone agrees to, so this post documents our own definition, in an attempt to bring a bit of clarity to the world."
image:
...
## Durability and Availability (and SLAs)
...
## Performance and Scalability (and how they relate to pricing)
