...
We could use a JSON column to store the product details. Let's do this by adding a `details` field to our table. You can do this via the UI or via the API like this:
