...
`pgroll` `v0.12` includes verbose mode for migrations, a usability improvement and one new constraint type. Most of the features were suggested by you, the community. We appreciate your participation and insightful suggestions coming from you. Let's take a look at what went into the `v0.12` release in more detail:
...
The output of `start` is short and consise:
