...
Today,as part of our [Xata Launch week](), we are thrilled to announce the [v1.0.0 release](https://pypi.org/project/xata/1.0.0/) of our [Python SDK](/docs/python-sdk/overview).
