...
Over the past year, we have launched numerous new features including [file attachments](https://xata.io/docs/sdk/file-attachments), SQL proxy, and a completely redesigned user interface. Additionally, we introduced a new website, tackled schema migration issues with [pgroll](https://xata.io/blog/pgroll-schema-migrations-postgres), and significantly enhanced our Python and Go SDK offerings, among other developments.
