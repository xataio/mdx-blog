...
description: "We're announcing the next major evolution for the Xata data platform: we are now offering a serverless Postgres service, and we think it is one the best ways to run Postgres in the cloud today."
image:
