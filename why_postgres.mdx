...
Making this possible was an interesting and large technical challenge, and we'll go into more detail in this blog post. The new Postgres-enabled databases are in public beta, see the [Get started](#get-started) for how to opt-in and use them.
