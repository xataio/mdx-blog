...
date: 03-20-2024
tags: ['engineering', 'drizzle', 'announcements', 'launch-week']
published: false
image:
...
With [this week's beta release of Xata's Postgres service](https://xata.io/blog/why-postgres) you are now able to connect to your Xata database with Drizzle over the Postgres wire protocol too with the `drizzle-orm/node-postgres` or `drizzle-orm/postgres-js` drivers.
...
And that's it, it's that easy to connect Drizzle to your Xata database. This functionality is currently only available with the public beta of our Postges service.
