...
<ArticleImage
  src="https://raw.githubusercontent.com/xataio/mdx-blog/main/images/amazon_faceted_search.png"
  width="440"
  height="466"
  alt="Faceted search on amazon.com"
  caption="Faceted search on amazon.com"
  position="center"
/>
...
We've seen the PostgreSQL full-text search primitives, and how we can we can combine them to create a pretty advanced full-text search engine, which also happens to support things like joins and ACID transactions. In other words, it has functionality that the other search engines typically don't have.
