...
Note: csv files are treated as plain text in the context of this script. We recommend using the purpose-built [Import CSV](https://xata.io/docs/csv-data/import-data) feature for ingesting csv files in a schema that mirrors the CSV file structure.
