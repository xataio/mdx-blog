...
1. Free install or sign up: [Prisma](https://www.prisma.io/orm), [Inngest](https://app.inngest.com/sign-up), [Clerk](https://dashboard.clerk.com/sign-up).
1. Check out this [PXCI starter stack](https://github.com/inngest/next-pxci-starter) to help get you started.
1. [Submit your project](https://5i8caik7lja.typeform.com/to/tWtK3ZlG) and agree to the [terms and conditions](https://docs.google.com/document/d/1VQCbns0abAt5jBi1e2zf11PMfDMA3MgZw4CjiNkYDUY/edit).
...
Join our dedicated Hackathon channel (**#hackathon**) on the [Xata Community Discord](https://xata.io/discord) for help and support. The Xata and Partner teams will be available **Monday to Friday**, from **5am to 5pm ET**. Any queries outside these hours will be addressed to the best of our ability or the next working day.
