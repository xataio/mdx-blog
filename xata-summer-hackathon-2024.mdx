...
- **Requirements:** Use the full stack (Xata, Clerk, Inngest, Prisma) to create an app.
...
1. Download or sign up for [Prisma](https://console.prisma.io/login), [Inngest](https://app.inngest.com/sign-up), [Clerk](https://dashboard.clerk.com/sign-up).
1. Check out this [PXCI starter stack](https://github.com/inngest/next-pxci-starter) to help get you started.
1. [Submit your project](https://5i8caik7lja.typeform.com/to/tWtK3ZlG) and agree to the terms and conditions.
