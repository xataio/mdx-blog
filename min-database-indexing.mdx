---
title: Xata 3-Minute Read: basics of database indexing 
description: 'Learn about the basics of database indexing - what is a database index and what does it do?'
image:
...
> Want to grasp a complex concept in the time it takes to brew your morning coffee?  In our **Xata 3-Minute Reads** series we offer concise explanations to help you unravel intricate database concepts without the time commitment. Today we are looking at **database indexing**.
