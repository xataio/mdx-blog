...
<div style={{ width: '33%', height: 'auto', display: 'flex', justifyContent: 'center' }}>
  ![Xata schema showing a many-to-one relationship](images/many-to-one-relationship-schema.png)
</div>
