...
- Subqueries: The primary advantage is that we don't increase the number of queries. Although, this is at the cost of introducing some complexity into the existing query and statement builder code.
