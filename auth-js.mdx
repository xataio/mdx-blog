---
title: "Xata and Auth․js on two Next․js apps: app directory and pages directory"
description: "Let's build Next.js apps with JWT authentication, with Auth.js and Xata. With app directory and React Server Components, or with the traditional pages routing system."
image:
...
<ArticleImage src="https://xata.io/images/blog/auth_js/diagram.png" width="954" height="420" alt="Diagram mapping how authentication will work in our app" caption="Our auth architecture" variant="crystalRiver" position="center" />
