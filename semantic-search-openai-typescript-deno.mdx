...
<ArticleImage src="https://xata.io/images/blog/semantic-search/embeddings_diagram.png" width="1630" height="368" alt="ML model for search" caption="Breaking down the model" position="center" />
...
<ArticleImage src="https://xata.io/images/blog/semantic-search/add_vector_type_screenshot.png" width="450" height="505" alt="Adding vector search" caption="Adding vector search" position="center" />

When you are done, the schema should look like this:

<ArticleImage src="https://xata.io/images/blog/semantic-search/view_schema_screenshot.png" width="450" height="344" alt="Vector search in our schema" caption="Vector search in our schema" position="center" />
...
<ArticleImage src="https://xata.io/images/blog/semantic-search/xata_init_install_screenshot.png" width="1342" height="862" alt="Running xata init" caption="Running xata init" position="center" />
...
<ArticleImage src="https://xata.io/images/blog/semantic-search/view_data_screenshot.png" width="2310" height="1448" alt="Content in the UI" caption="Content in the UI" position="center" />
