...
<ArticleImage src="https://xata.io/images/blog/semantic-search/xata_init_install_screenshot.png" width="450" height="344" alt="Running xata init" caption="Running xata init" variant="crystal_river" position="center" />
