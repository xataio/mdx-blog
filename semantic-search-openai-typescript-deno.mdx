...
<ArticleImage src="https://xata.io/images/blog/semantic-search/xata_init_install_screenshot.png" width="1342" height="862" alt="Running xata init" caption="Running xata init" variant="true_sunset" position="center" />
