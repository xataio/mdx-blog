...
<ArticleImage src="https://xata.io/images/blog/semantic-search/embeddings_diagram.png" width="1630px" height="368px" alt="ML model for search" caption="Breaking down the model" variant="crystal_river" position="center" />
