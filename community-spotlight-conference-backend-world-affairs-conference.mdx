---
title: 'Reinventing the conference management backend of the World Affairs Conference'
description: 'Putting the spotlight on Samuel Martineau, a software engineer based out of Ontario, Canada replacing the backend of a conference management system with Xata.'
image:
  src: https://raw.githubusercontent.com/xataio/mdx-blog/main/images/cs-wac-cover.jpg
...
ogImage: https://raw.githubusercontent.com/xataio/mdx-blog/main/images/cs-wac-cover.jpg
---

[Samuel Martineau](https://github.com/Samuel-Martineau) has not even graduated high school yet and is already racking up an impressive list of professional accomplishments. From being on national TV for his [wall climbing robot](https://github.com/Samuel-Martineau/memomath), to leading the team and architectural design for the new management system of the worlds oldest student run conference, the [World Affairs Conference](https://worldaffairscon.org/). The conference brings in over 4,000 of the worlds brightest minds from 25 countries in 65 schools internationally. As Samuel gets ready to graduate from the [Upper Canada College](https://en.wikipedia.org/wiki/Upper_Canada_College), he looks to take his talents the world of mechatronics, pursuing a degree in mechanical engineering at a Canadian university.
...
> I think we used pretty much every feature Xata offers. From user profile and speaker images are stored in Xata, the summarize API for sign up and registration time series charts, preview databases with Netlify, full text search and more. Having one service to provide all of this functionality made it a pretty easy decision to choose Xata.
> _Samuel Martineau - Title_

On the frontend, [Sveltekit](https://kit.svelte.dev/), [three.js](https://threejs.org/) and [AG Grid](https://ag-grid.com/) were used to build the website, registration application and internal administrative dashboards. All of this was deployed on [Netlify](https://www.netlify.com/), where the [Xata - Netlify](https://xata.io/docs/integrations/netlify) integration was used to provide preview deployments in their CI/CD pipeline. Pull request generated previews were critical to the development process for the team, making it easy to test changes before deploying to production.
...
In order to perform interactive analytics on the data itself, the team relied on [Xata aggregations](https://xata.io/docs/sdk/aggregate). This allowed them to chart the number of sign ups over time and segment based on schools and other profile attributes. The view of the data will help future conference administrators with outreach, promotion and further optimization.

![Dashboard for attendee and speaker analytics](/images/cs-wac-admin-dashboard.png)
...
Both the conference and administrative dashboard can be found in their [open source GitHub repository](https://github.com/worldaffairsconference/worldaffairscon.org).
