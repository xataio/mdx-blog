...
description: 'Putting the spotlight on Samuel Martineau, a software developer apprentice based out of Ontario, Canada replacing the backend of a conference management system with Xata.'
image:
