---
title: "How HydroPro Solutions achieved a 60% reduction in search time using the Xata Postgres-powered platform"
...
- **Manage file attachments:** Storing photos taken during meter installations and using Google Cloud Vision to read meter serial numbers, which are automatically linked to customer records.
