...
Say you want to retrieve information from the table of products, you can use a SQL `SELECT` statement. Using the table mentioned above, with columns for the product name, price, and description, here's an example SQL query to retrieve the information:
...
<ArticleImage
  ...
  caption= "Source:"[DB engine rankings](https://db-engines.com/en/ranking)
  position="center"
/>
...
Here's a summary of the main points made in this post, comparing SQL, MySQL, PostgreSQL, and NoSQL:
...
Want to add to the database discussions? Reach out to us on [Discord](https://xata.io/discord) or follow us on [Twitter](https://twitter.com/xata). We'd love to hear your thoughts, answer your questions, and keep you updated on the latest at Xata.
