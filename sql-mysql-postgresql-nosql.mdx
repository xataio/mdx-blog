...
description: 'An exploration of the MySQL,PostgreSQL, and NoSQL database options and discussion on where and when to use them.'
image:
...
![](/images/database-platforms-trend.png)
