...
For questions or feedback, feel free to reach out to us on [X / Twitter](https://twitter.com/xata) or [Discord](https://xata.io/discord). [Sign up](https://app.xata.io/signin?mode=signup) today to get started with Xata 🚀 
