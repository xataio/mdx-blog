...
Using SQL over HTTP offers the benefit of easy integration within serverless environments, including Cloudflare Workers, similar to the rest of the Xata SDK. Our roadmap includes expanding SQL support and introducing the Postgres Wire protocol for maximum compatibility.
