...
As we mentioned above, we run a PostgreSQL instance that stores your database. By enabling SQL access, you gain the ability to directly interact with and manipulate database rows within PostgreSQL.
