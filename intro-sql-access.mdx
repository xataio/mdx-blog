...
The above examples, however, could be easier achieved using the Xata API, and we generally recommend you using the Xata SDKs for this types of queries because they provide better type safety-ness and overall a better developer experience.
