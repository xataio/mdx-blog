...
image:
  src: https://raw.githubusercontent.com/xataio/mdx-blog/main/images/community-spotlight-simplified-architecture-hotel.png
...
ogImage: https://raw.githubusercontent.com/xataio/mdx-blog/main/images/community-spotlight-simplified-architecture-hotel.png
---

[Emanuel Arcos](https://www.linkedin.com/in/emanuelarcos/), a full-stack developer from Buenos Aires with over 7 years of e-commerce experience, is making waves. Over the last few years, he picked up Next.js and left the e-commerce world to become an entrepreneur — with his eyes set on a brand new type of subscription service.
...
![Will need to swap out with an approved screenshot](/images/cs-kinesiology.png)
...
![Will need to swap out with an approved screenshot](/images/cs-hotel-mgt-01.png)
...
> Xata saved my life. I’m not great at DevOps and database infrastructure management. That’s very boring work for me and Xata handles this for me with a great developer experience. Thanks to Xata, I was able to build out both of these applications in just two months.\n
...
He and plans to have different features such as scheduling, invoice generation, inventory and revenue management available on different tiers and hotels can choose from the a la carte menu for what suits their needs best.

The new software is still in the works, and Emanuel is planning to add full-text search and file attachments to a number of experiences. If you’re interested in learning more, don’t hesitate to reach out.
