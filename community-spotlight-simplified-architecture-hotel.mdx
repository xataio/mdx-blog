...
[Emanuel Arcos](https://www.linkedin.com/in/emanuelarcos/), a full-stack developer from Buenos Aires with over 7 years of e-commerce experience, is making waves. Recently, he left the e-commerce world to start his compnay Triqueta Software Solutions and become an entrepreneur with his eyes set on a brand new type of subscription service.
...
The new software is still in the works, and Emanuel is planning to add full-text search and file attachments to a number of experiences. If you’re interested in learning more, don’t hesitate to reach out on [LinkedIn](https://www.linkedin.com/in/emanuelarcos/).
