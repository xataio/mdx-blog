...
description: A guide to get Xata running with Astro
image:
...
# Xata with Astro edit the title
...
<ArticleImage src="https://xata.io/docs/images/docs/getting-started/posts.png" width="1688" height="949" alt="A xata table of posts" caption="A simple posts table" variant="magic_ray" position="center" />
