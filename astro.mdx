...
<ArticleImage src="https://xata.io/docs/images/docs/getting-started/posts.png" width="1688" height="949" alt="A xata table of posts" caption="A simple posts table" variant="night_party" position="center" />
