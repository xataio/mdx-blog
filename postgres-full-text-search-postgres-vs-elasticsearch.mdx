...
![Typical architecture with PostgreSQL and Elasticsearch](images/postgres-plus-elasticsearch.svg)
...
![Postgres-only search architecture](images/postgres-only-search.svg)
...
![Postgres and Elasticsearch use cases](images/postgres-and-elasticsearch-usecases.svg)
