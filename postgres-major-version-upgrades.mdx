...
image:
  src: https://raw.githubusercontent.com/xataio/mdx-blog/branch-moving/images/images/branch-moving-cover.jpg
...
ogImage: https://raw.githubusercontent.com/xataio/mdx-blog/branch-moving/images/images/branch-moving-cover.jpg
---
...
### Database branch moving in Xata

Today, we are launching branch moving, which allows Xata users to move a database between two Postgres clusters while it's still being
...
We implemented a blue-green approach in order to offer the ability to move databases. Trying to hide all the complexity behind a simple
user experience.
...
![moving a database branch](/images/branch-moving-process.png)
...
- Potentially achieve real zero-downtime by holding, then redirecting writes in the proxy, effectively avoiding killing any connection.
...
Of course, we would love hear your feedback and ideas! If you are interested, please reach out to us on [Discord](https://xata.io/discord) or
