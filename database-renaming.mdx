...
That is the tale of database renaming. Let us know if you find any issues either on Github or [Discord](https://xata.io/discord). If you don't have a Xata account yet, s[ign up for free!](https://app.xata.io/signin) We have a very generous free plan.
