...
| ---------------------------------- | ------------------------------------------------------------------------------- |
| https://xata.io                    | Serverless database platform for scalable, real-time applications.              |
| https://remix.run                  | Framework for building full-stack web applications with focus on Web Standards. |
| https://github.com/BerriAI/litellm | Call all LLM APIs using the OpenAI format.                                      |
| https://novel.sh                   | A Notion-style WYSIWYG editor with AI-powered autocompletion                    |
| https://tailwindcss.com/           | CSS framework for building custom designs                                       |
| https://vercel.com                 | A cloud platform for deploying and scaling web applications.                    |
...
![View table schema](/images/cms-remix-xata-03.png)
