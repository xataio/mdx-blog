---
title: Use Prisma with Xata's Postgres service
...
published: true
image:
  src: https://raw.githubusercontent.com/xataio/mdx-blog/main/images/prisma-integration/prisma-integration.jpg
  alt: 'Prisma Integration'
slug: prisma-postgres-xata-integration
ogImage: https://raw.githubusercontent.com/xataio/mdx-blog/main/images/prisma-integration/prisma-integration.jpg
---

[Prisma](https://www.prisma.io/) is very popular a Node.js and TypeScript ORM that provides typesafe access to your database, automated migrations, and a custom data model definition.

With [today's beta release of Xata's Postgres service](https://xata.io/blog/why-postgres) you are now able to connect to your Xata database with Prisma over the Postgres wire protocol. You can simply use the default Prisma ORM connector or Prisma driver adapters (`@prisma/adapter-pg`). This integration is
...
**Xata wire protocol requires SSL, so your connection URL defined here will need to contain `?sslmode=require` at the end.**
...
[Sign up today](https://app.xata.io/signin?mode=signup) to get started! We're always around if you have any questions. Pop into pop into [Discord ](https://xata.io/discord) and say hi or reach out on [X | Twitter](https://twitter.com/xata). Happy building 🦋
