...
![Enable direct access for your workspace](/images/prisma-integration/workspace.png)

You will also need to enable direct access to Postgres when you create your new database.

![Enable direct access for your database](/images/prisma-integration/database.png)
