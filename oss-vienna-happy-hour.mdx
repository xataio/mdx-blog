...
The passage is coherent and reads well, conveying a personal and relatable story. However, a few minor edits can improve the flow and clarity:

1. **Punctuation and Sentence Structure**: Adding commas where needed and breaking down a longer sentence for better readability.
2. **Clarity**: Clarifying the timeline in the first sentence for smoother comprehension.
