...
<Alert status="warning">
  The Workers Beta waitlist is currently closed, in favor of strengthening Xata's integrations with full-stack frameworks like Next.js.
  You can check out our public [Roadmap](https://xata.io/roadmap) and get in touch via [Discord](https://xata.io/discord), or [Contact Support](https://support.xata.io/hc/en-us/requests/new) if you have any questions.
</Alert>
