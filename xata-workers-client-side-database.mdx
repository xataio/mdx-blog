...
description: "Xata Workers act as middleware to simplify database access and allow their developers to deploy functions that sit in front of their databases."
image:
...
![Cover image](https://blog.cloudflare.com/content/images/2022/11/Customer-Story_-Xata_light.png)
...
<ArticleImage src="https://blog.cloudflare.com/content/images/2022/11/Untitled.png" width="923" height="455" alt="Intellisense" caption="Intellisense" position="center" />
![SDK Intellisense](https://blog.cloudflare.com/content/images/2022/11/Untitled.png)
...
<ArticleImage src="https://blog.cloudflare.com/content/images/2022/11/Untitled--1-.png" width="1600" height="883" alt="A diagram featuring Xata worker workflow with Cloudflare" caption="Xata workers with Cloudflare" position="center" />
...
Xata Workers are currently in private beta. If you are interested in trying them out, you can sign up for the [waitlist](https://xata.io/beta/workers) and talk us through your use case. We are looking for developers that are willing to provide feedback and shape this new feature for our serverless data platform.
