---
title: "Savas Labs saves 60+ hours in development time with Xata's Serverless Postgres solution"
description: 'See how Savas Labs saved 60+ hours with Xata’s serverless Postgres solution, improving database management and accelerating digital projects for clients like the Environmental Integrity Project.'
image:
  src: https://raw.githubusercontent.com/xataio/mdx-blog/main/images/sava-labs-case-study-og.png
  alt: Casse Study
...
- **Avoiding database management:** A The Savas Labs team wanted to avoid the complexities of managing a database infrastructure themselves.
- **API accessibility:** A They needed a solution that could easily provide an API layer over the existing Postgres database without the need for extensive backend development.
- **Data migration:** A Importing an existing Postgres database into a new system was a critical requirement.
- **Geospatial data management:** A Savas Labs needed a solution to efficiently handle geospatial data with robust querying capabilities and integration with mapping tools. In addition, handling [Postgres branching](https://xata.io/branching) for different project environments posed unique challenges, which required Xata’s support.
- **Collaborative visibility:** A The team required a platform that enabled visibility into data for better collaboration and project management.
