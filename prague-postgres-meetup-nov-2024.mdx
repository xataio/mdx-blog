...
<Alert flexDirection="column" alignItems="flex-start" gap="1">
  ...
  <Box as="span" color="titleAccent">
    A recent buzzword on the database scene is branching.
    Now it is a basic feature of serverless PostgreSQL services, including Neon, Supabase and Xata.
    The concept is adapted from git, and its definition and usage is similar to that of git.
    A branch is an isolated database instance to test your changes to your database instance.
    Testing changes on branches gives you confidence to work with your database.
    PostgreSQL provides several building blocks and options to serve isolated databases to users.
    Learn how we implemented branches at Xata while keeping thousands of branches in the same PostgreSQL database.
  </Box>
</Alert>
...
<Alert flexDirection="column" alignItems="flex-start" gap="1">
  ...
  <Box as="span" color="titleAccent">
    [pgroll](https://github.com/xataio/pgroll) is a new open-source migration tool for Postgres that keeps multiple versions of a schema live during a migration, helping you roll out database schema changes without downtime.
    We'll look at how it works, how it automates the expand/contract pattern, and a quick demo.
  </Box>
</Alert>
