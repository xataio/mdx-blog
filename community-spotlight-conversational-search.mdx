...
image:
  src: https://raw.githubusercontent.com/xataio/mdx-blog/main/images/community-spotlight-chat-search-experiences.jpg
  alt: Community Spotlight
author: Alex Francoeur
date: 10-18-2023
published: true
slug: community-spotlight-chat-search-experiences
ogImage: https://raw.githubusercontent.com/xataio/mdx-blog/main/images/community-spotlight-chat-search-experiences.jpg
---
...
![Briefly News](/images/cs_briefly_news.png)
...
Rather than having disparate services and data stores to handle each one of these use cases, all of the data is simply stored in a Xata database. The [Xata Python SDK](https://xata.io/docs/sdk/python/overview) and ORM-like experience was used for [filtering](https://xata.io/docs/sdk/filtering), [full-text search](https://xata.io/docs/sdk/search), [aggregations](https://xata.io/docs/sdk/aggregate) and [chat features](https://xata.io/docs/sdk/ask).
