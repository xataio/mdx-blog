...
date: 02-07-2023
published: true
slug: commuity-spotlight-rankone
---
...
<ArticleImage src="https://xata.io/images/blog/rankone/rankone.png" width="1920" height="1509" alt="Rankone page" caption="A Rankone profile" position="center" />
...
> The true serverless nature, the generous pricing plan and the developer experience was key for us when we picked Xata. <br />
> *Peter Spegel - Developer @ RankOne*
...
> As a small startup we don't have the resources to maintain a large set of technologies but with Xata it was so easy to set everything up. <br />
> *Peter Spegel - Developer @ RankOne*
...
> We were blown away by the workspace environment, the documentation and the incredible response time on Discord. It's rare that you find a product that just works.  <br />
> *Peter Spegel - Developer @ RankOne*
