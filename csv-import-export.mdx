...
image:
  src: 
  alt: 'https://raw.githubusercontent.com/xataio/mdx-blog/main/images/csv-import-export.jpeg'
author: Richard Gill
date: 08-28-2023
published: true
...
As part of our [launch week](/blog/launch-week-august-2023), we’re introducing a new CSV import UI experience, built from scratch, to make your Xata journey simpler - allowing you to automatically add new tables by importing your data directly into a Xata database. Also, we’ve added an export feature that allows you seamlessly download your data as a CSV file.
