...
image:
  ...
  alt: 'Bring and take your own data with CSV import and export'
...
Love it or hate it, CSV is simply the world's most popular data format. While the option to import CSV files via the [Xata CLI](/docs/csv-data/import-data#import-csv-data-with-the-cli) has always been part of our offering, we've taken things a step further.
