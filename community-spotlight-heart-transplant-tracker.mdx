...
We're putting our spotlight on [Daniel Reale](https://www.linkedin.com/in/danreale/), a QA engineer by day at a leading data and advertising company, and a web application developer by night. His technical skills and personal dedication have driven him to create a vital application with a deeply personal mission - [a heart transport waitlist tracker](https://heart-transplant.netlify.app/).

![Heart Transplant Tracker at a glance](/images/tracker-at-a-glance.png)
...
![Automating the scraping process - code view 1](/images/scraping-view1.png)

![Automating the scraping process - code view 2](/images/scraping-view2.png)
...
![Historical data easily accessible at a glance](/images/historical-data.png)
...
![Visual graphs showing the data](/images/visual-graphs.png)
