...
| SELECT ctid, id, name, salary, xmin, xmax<br>FROM employees<br>WHERE id = 1;<br>-- Sees: salary = 50000 | | (0,1) \| 1 \| Alice \| 50000 \| 99 \| null |
| | BEGIN; | (0,1) \| 1 \| Alice \| 50000 \| 99 \| null |
| | UPDATE employees<br>SET salary = 60000<br>WHERE id = 1; | (0,1) \| 1 \| Alice \| 50000 \| 99 \| 101<br>(0,2) \| 1 \| Alice \| 60000 \| 101 \| null |
| SELECT ctid, id, name, salary, xmin, xmax<br>FROM employees<br>WHERE id = 1;<br>-- Sees: salary = 50000 | | (0,1) \| 1 \| Alice \| 50000 \| 99 \| 101<br>(0,2) \| 1 \| Alice \| 60000 \| 101 \| null |
| | COMMIT; | (0,1) \| 1 \| Alice \| 50000 \| 99 \| 101<br>(0,2) \| 1 \| Alice \| 60000 \| 101 \| null |
| SELECT ctid, id, name, salary, xmin, xmax<br>FROM employees<br>WHERE id = 1;<br>-- Sees: salary = 60000 | | (0,1) \| 1 \| Alice \| 50000 \| 99 \| 101<br>(0,2) \| 1 \| Alice \| 60000 \| 101 \| null |
| COMMIT; | | (0,1) \| 1 \| Alice \| 50000 \| 99 \| 101<br>(0,2) \| 1 \| Alice \| 60000 \| 101 \| null |
